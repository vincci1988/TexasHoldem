...
public class TournamentChampionMatch implements ManualTest {
	...
	public void run() throws Exception {
		...
		players.add(new CandidStatistician(1, 1.554, 0.7157, 0.5420));
		players.add(new CandidStatistician(2, 1.4378, 0.7402, 0.5731));
		players.add(new CandidStatistician(3, 1.2670, 0.7389, 0.5722));
		players.add(new CandidStatistician(4, 1.1304, 0.7984, 0.6008));
